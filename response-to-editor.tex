...
stochastic helper paths so the manuscript computations use serial
\proglang{R}-controlled random-number streams.
...
\proglang{R}-controlled random-number streams. The package passes
\code{R CMD check --as-cran} under \proglang{R} 4.6.0, and the full JSS
replication was rerun with this public package version.
