...
serial \proglang{R}-controlled random-number streams and adds tests for repeated
seed behavior.
...
\proglang{R}-controlled random-number streams. We added package tests for
repeated-seed behavior in the compiled samplers, dynamic MCMC, and static MCMC
paths, and the package passes \code{R CMD check --no-manual --run-donttest}
under \proglang{R} 4.6.0.
