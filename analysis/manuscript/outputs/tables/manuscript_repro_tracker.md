...
Generated: 2026-04-20 03:19:50
Profile: standard
Seed: 20260302

## Artifact Status

- [reproduced] `fig_ex3data` -> `analysis/manuscript/outputs/figures/ex3data.png` (fig:ex3data). Top: log monthly Big Tree flow aggregated from the staged daily file. Middle: monthly mean precipitation. Bottom: monthly mean soil moisture.
- [reproduced] `ex3_run_summary` -> `analysis/manuscript/outputs/logs/ex3_run_summary.txt` (Example 3 textual outputs). Monthly USGS/ppt/soil Example 3 summary including lambda optimization table and median.kt.
- [reproduced] `ex3_run_summary_ldvb` -> `analysis/manuscript/outputs/logs/ex3_run_summary_ldvb.txt` (new: Example 3 LDVB textual outputs). LDVB monthly USGS/ppt/soil counterpart including lambda scan and runtime summaries.
...
- [reproduced] `tab_ex3_lambda_scan` -> `analysis/manuscript/outputs/tables/ex3_lambda_scan_kl.csv` (Example 3 lambda selection output). Primary LDVB lambda scan; best lambda in this run=0.100
...
- ex3: Best LDVB lambda by KL in this run profile: 0.100.
