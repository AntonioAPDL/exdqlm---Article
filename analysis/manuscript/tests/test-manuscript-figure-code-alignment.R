...
testthat::test_that("displayed figure chunks retain canonical visual markers", {
  ...
  testthat::expect_true(grepl("exdqlmPlot", fig6_top, fixed = TRUE))
  testthat::expect_true(grepl("plot = FALSE", fig6_top, fixed = TRUE))
  testthat::expect_true(grepl("add = TRUE", fig6_top, fixed = TRUE))
  testthat::expect_true(grepl("compPlot", fig6_seasonal, fixed = TRUE))
  testthat::expect_true(grepl("compPlot", fig6_covariate, fixed = TRUE))
  ...
  testthat::expect_true(grepl("compPlot", fig7, fixed = TRUE))
  testthat::expect_true(grepl("plot = FALSE", fig7, fixed = TRUE))
  testthat::expect_true(grepl("add = TRUE", fig7, fixed = TRUE))
  testthat::expect_true(grepl("just.theta = TRUE", fig7, fixed = TRUE))
