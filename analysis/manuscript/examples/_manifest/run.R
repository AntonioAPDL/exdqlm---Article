...
if (targeted_run) {
  target_map <- list(
    ...
    ex3tables = c("tab_ex3_forecast_comparison", "tab_ex3_diagnostics", "tab_ex3_lambda_selection", "tab_ex3_forecast_metrics", "tab_ex3_sensitivity_forecast_metrics"),
    ex3tables_ldvb = c("tab_ex3_forecast_comparison", "tab_ex3_diagnostics", "tab_ex3_lambda_selection", "tab_ex3_forecast_metrics", "tab_ex3_sensitivity_forecast_metrics"),
