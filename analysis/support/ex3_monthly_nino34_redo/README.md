...
```bash
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R
```

Useful variants:

```bash
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R --targets prep,fit
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R --targets figures,manifest
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R --config analysis/support/ex3_monthly_nino34_redo/config_launchcheck.yml
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R --config analysis/support/ex3_monthly_nino34_redo/config_q7_full.yml
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R --config analysis/support/ex3_monthly_nino34_redo/config_allidx_launchcheck.yml
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R --config analysis/support/ex3_monthly_nino34_redo/config_allidx_intermediate.yml
Rscript analysis/support/ex3_monthly_nino34_redo/run_all.R --config analysis/support/ex3_monthly_nino34_redo/config_reduced6_crps_dense.yml
```
...
```bash
bash analysis/support/ex3_monthly_nino34_redo/run_reduced6_crps_dense_background.sh
bash analysis/support/ex3_monthly_nino34_redo/check_reduced6_crps_dense_status.sh
```
...
```bash
bash analysis/support/ex3_monthly_nino34_redo/run_full_q7.sh
```
