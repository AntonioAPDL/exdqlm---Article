...
cd "${repo_root}"
setsid bash -lc "cd '${repo_root}' && exec Rscript analysis/support/ex3_daily_redo/run_all.R --config analysis/support/ex3_daily_redo/config_full_history_q7_refresh_lag3_150.yml" \
