...
cd "${repo_root}"
setsid bash -lc "cd '${repo_root}' && exec Rscript analysis/support/ex3_daily_redo/run_all.R --config analysis/support/ex3_daily_redo/config_long_nightly_1000.yml" \
