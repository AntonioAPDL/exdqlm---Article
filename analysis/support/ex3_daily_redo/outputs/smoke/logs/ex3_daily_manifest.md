...
- config path: `/home/jaguir26/local/src/exdqlm---Article/analysis/support/ex3_daily_redo/config_smoke.yml`
- output tag: `smoke`
...
- quantiles: `0.05, 0.5`
- LDVB settings: tol=0.1, n.samp=60, max_iter=25, gam.init=0, sig.init=0.2
...
- p0=0.05 | direct_regression | status=ok | iter=25 | converged=FALSE | hit_iter_cap=TRUE | runtime=56.155 | median.kt=NA
- p0=0.05 | transfer_function | status=ok | iter=25 | converged=FALSE | hit_iter_cap=TRUE | runtime=60.989 | median.kt=45.33101
- p0=0.50 | direct_regression | status=ok | iter=25 | converged=FALSE | hit_iter_cap=TRUE | runtime=56.595 | median.kt=NA
- p0=0.50 | transfer_function | status=ok | iter=25 | converged=FALSE | hit_iter_cap=TRUE | runtime=60.994 | median.kt=34.67451

## Diagnostics snapshot

- p0=0.05 | direct_regression | KL=0.72155469 | CRPS= 1.959783 | pplc= 4285.597 | runtime=56.155
- p0=0.05 | transfer_function | KL=0.86303942 | CRPS= 1.887660 | pplc= 4123.743 | runtime=60.989
- p0=0.50 | direct_regression | KL=0.05502216 | CRPS=11.823887 | pplc=23301.676 | runtime=56.595
- p0=0.50 | transfer_function | KL=0.12937493 | CRPS=10.242232 | pplc=20229.348 | runtime=60.994
