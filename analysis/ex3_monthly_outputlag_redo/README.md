...
- the monthly Nino34 contrast under `analysis/ex3_monthly_nino34_redo/`
...
```bash
Rscript analysis/ex3_monthly_outputlag_redo/run_all.R
```

Useful variants:

```bash
Rscript analysis/ex3_monthly_outputlag_redo/run_all.R --targets prep,fit
Rscript analysis/ex3_monthly_outputlag_redo/run_all.R --targets figures,manifest
Rscript analysis/ex3_monthly_outputlag_redo/run_all.R --config analysis/ex3_monthly_outputlag_redo/config_launchcheck.yml
Rscript analysis/ex3_monthly_outputlag_redo/run_all.R --config analysis/ex3_monthly_outputlag_redo/config_q7_full.yml
...
```bash
bash analysis/ex3_monthly_outputlag_redo/run_full_q7.sh
```
