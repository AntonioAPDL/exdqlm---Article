...
| `tab:ex3` | `analysis/manuscript/outputs/tables/ex3_forecast_comparison.csv` | tracked table only |
...
- [ex3_forecast_comparison.csv](/data/muscat_data/jaguir26/exdqlm---Article/analysis/manuscript/outputs/tables/ex3_forecast_comparison.csv)
...
- [ex3_lambda_selection.csv](/data/muscat_data/jaguir26/exdqlm---Article/analysis/manuscript/outputs/tables/ex3_lambda_selection.csv)
