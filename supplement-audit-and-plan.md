...
- Package repo: `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs`
- Package branch: `feature/0.5.0-crps-iqs`
...
- `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/static_beta_prior.R`
...
- `exdqlmMCMC()`:
  `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/exdqlmMCMC.R`,
  function definition near line 246.
- `exdqlmLDVB()`:
  `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/exdqlmLDVB.R`,
  function definition near line 148.
Static functions:

- `exalStaticMCMC()`:
  `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/exalStaticMCMC.R`,
  function definition near line 198.
- `exalStaticLDVB()`:
  `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/exalStaticLDVB.R`,
...
- Bounded univariate slice sampler:
  `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/utils.R`,
  line 239.
- Static AL alias `al.ind` for `dqlm.ind`:
  `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/utils.R`,
  line 613.
- Global inference controls and warmup configuration:
  `/data/muscat_data/jaguir26/exdqlm__wt__0.5.0-crps-iqs/R/exal_inference_config.R`.
...
- Suggested path:
  `/data/muscat_data/jaguir26/exdqlm---Article/exdqlm-supplement.tex`
...
## 13. Implementation-match audit against `feature/0.5.0-crps-iqs`
