...
This appendix connects the package interface in the main text with the
...
Table~\ref{tab:app_roadmap} gives an overview of the appendix contents.
...
\midrule
A. Technical overview and notation &
Defines the role of the appendix and the distributional conventions used by
the package. \\
...
\end{tabularx}
\endgroup
\caption{Overview of appendix contents.}
