...
The main text describes the user-facing workflow for \pkg{exdqlm}: dynamic
exDQLM and DQLM fitting, transfer-function models, static exAL regression,
forecasting, diagnostics, and posterior-predictive synthesis. This appendix
...
numerical routines used by the package. Readers can use this appendix to
