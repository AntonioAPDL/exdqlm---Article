...
\begin{tabular}{@{}llrrrr@{}}
 ...
 \midrule
 \tworowcell{DQLM} & LDVB & \textbf{23.40} & \textbf{0.133} & 8.525 & 3851.4 \\
 & MCMC & 155.64 & 0.175 & \textbf{7.608} & \textbf{2969.0} \\
 \midrule
 \tworowcell{exDQLM} & LDVB & \textbf{45.54} & \textbf{0.107} & 6.558 & 3015.2 \\
 & MCMC & 207.00 & 0.152 & \textbf{5.147} & \textbf{2216.1} \\
 \bottomrule
\end{tabular}
...
\begin{tabular}{@{}llrrrr@{}}
 ...
 \midrule
 \tworowcell{0.05} & LDVB & \textbf{33.82} & 0.108 & \textbf{0.034} & 0.673 \\
 & MCMC & 82.70 & \textbf{0.069} & 0.035 & \textbf{0.594} \\
 \midrule
 \tworowcell{0.25} & LDVB & \textbf{30.19} & 0.310 & 0.078 & 0.371 \\
 & MCMC & 82.45 & \textbf{0.271} & \textbf{0.065} & \textbf{0.329} \\
 \midrule
\tworowcell{0.50} & LDVB & \textbf{13.54} & \textbf{0.128} & 0.103 & 0.341 \\
 & MCMC & 82.90 & 0.141 & \textbf{0.083} & \textbf{0.335} \\
 \bottomrule
\end{tabular}}
...
Table \ref{tab:ex4static} includes active-signal RMSE and null-coefficient MAE summaries stored in the \code{exalStaticDiagnostic} objects returned by \code{diagnostics()}. The results reinforce the visual comparison in Figure \ref{fig:ex4static}. The MCMC posterior-simulation fit has the smaller holdout quantile RMSE in all three fits, although the median difference is small. MCMC gives smaller active-signal RMSE at \(p_0 = 0.05\) and \(p_0 = 0.25\), while LDVB is slightly smaller at \(p_0 = 0.50\). Null-coefficient MAE is slightly smaller for LDVB at \(p_0 = 0.05\) and for MCMC at \(p_0 = 0.25\) and \(p_0 = 0.50\). The LDVB fit is nevertheless faster in all three cases, with runtime reductions of roughly 2.4-fold at \(p_0 = 0.05\), 2.7-fold at \(p_0 = 0.25\), and 6.1-fold at \(p_0 = 0.50\). In this benchmark, the LDVB approximation is useful as a rapid first-pass screen, while static MCMC provides a more expensive posterior-simulation comparison when interval accuracy or posterior tail behavior is central.
