...
the nonconjugate variational strategy of \citet{wang2013nonconjugatevb}.
...
The scale and skewness parameters are updated separately from the latent-state blocks. By default, the package integrates $\sigma$ out of the conditional target for $\gamma$, updates $\gamma$ on its bounded logit scale using a univariate slice sampler \citep{neal2003slice}, and then redraws $\sigma$ from its exact GIG conditional distribution. Joint
...
The variational routines return standardized traces for the ELBO, scale, skewness, and convergence diagnostics, with the closed-form, structured scale--skewness, and legacy Laplace--delta ELBO components documented in the appendices. The examples use a fixed backend profile, recorded random-number seeds, and a documented reference environment so that run times and stochastic outputs are reproducible.
...
\begin{tabular}{@{}llrrrr@{}}
 ...
 \midrule
 \tworowcell{DQLM} & LDVB & \textbf{24.86} & \textbf{0.133} & 8.525 & 3851.4 \\
 & MCMC & 166.66 & 0.175 & \textbf{7.608} & \textbf{2969.0} \\
 \midrule
 \tworowcell{exDQLM} & LDVB & \textbf{47.85} & \textbf{0.107} & 6.558 & 3015.2 \\
 & MCMC & 220.39 & 0.152 & \textbf{5.147} & \textbf{2216.1} \\
 \bottomrule
\end{tabular}
...
\begin{tabular}{@{}llrrrr@{}}
 ...
 \midrule
 \tworowcell{0.05} & LDVB & \textbf{35.30} & 0.108 & \textbf{0.034} & 0.673 \\
 & MCMC & 81.44 & \textbf{0.069} & 0.035 & \textbf{0.594} \\
 \midrule
 \tworowcell{0.25} & LDVB & \textbf{30.91} & 0.310 & 0.078 & 0.371 \\
 & MCMC & 79.65 & \textbf{0.271} & \textbf{0.065} & \textbf{0.329} \\
 \midrule
\tworowcell{0.50} & LDVB & \textbf{14.22} & \textbf{0.128} & 0.103 & 0.341 \\
 & MCMC & 81.99 & 0.141 & \textbf{0.083} & \textbf{0.335} \\
 \bottomrule
\end{tabular}}
...
nonconjugate variational inference \citep{wang2013nonconjugatevb} to this
...
computes the expectations needed in \eqref{eq:dyn_exdqlm_kappa} using the
...
\eqref{eq:dyn_exdqlm_ld_objective}. For the default structured factor, the
