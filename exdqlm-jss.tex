...
\begin{tabular}{@{}llrrrr@{}}
 ...
 \midrule
 \tworowcell{DQLM} & LDVB & \textbf{23.84} & \textbf{0.133} & 8.525 & 3851.4 \\
 & MCMC & 153.02 & 0.176 & \textbf{7.605} & \textbf{2954.9} \\
 \midrule   
 \tworowcell{exDQLM} & LDVB & \textbf{43.48} & \textbf{0.107} & 6.558 & 3015.2 \\
 & MCMC & 200.02 & 0.164 & \textbf{5.091} & \textbf{2194.8} \\
 \bottomrule   
\end{tabular}
...
18 observations, July 2021 through December 2022, form the forecast holdout. The essential data alignment is shown below. The replication script adds
...
\begin{tabular}{@{}llrrrr@{}}
 ...
 \midrule
 \tworowcell{0.05} & LDVB & \textbf{30.92} & 0.108 & \textbf{0.034} & 0.673 \\
 & MCMC & 68.15 & \textbf{0.069} & 0.035 & \textbf{0.594} \\
 \midrule
 \tworowcell{0.25} & LDVB & \textbf{27.39} & 0.310 & 0.078 & 0.371 \\
 & MCMC & 67.21 & \textbf{0.271} & \textbf{0.065} & \textbf{0.329} \\
 \midrule
\tworowcell{0.50} & LDVB & \textbf{12.42} & \textbf{0.128} & 0.103 & 0.341 \\
 & MCMC & 67.96 & 0.141 & \textbf{0.083} & \textbf{0.335} \\
 \bottomrule
\end{tabular}}
...
Table \ref{tab:ex4static} includes active-signal RMSE and null-coefficient MAE summaries stored in the \code{exalStaticDiagnostic} objects returned by \code{diagnostics()}. 
...
The results reinforce the visual comparison in Figure \ref{fig:ex4static}. The MCMC posterior-simulation fit has the smaller holdout quantile RMSE in all three fits, although the median difference is small. MCMC gives smaller active-signal RMSE at \(p_0 = 0.05\) and \(p_0 = 0.25\), while LDVB is slightly smaller at \(p_0 = 0.50\). Null-coefficient MAE is slightly smaller for LDVB at \(p_0 = 0.05\) and for MCMC at \(p_0 = 0.25\) and \(p_0 = 0.50\). The LDVB fit is nevertheless faster in all three cases, with runtime reductions of roughly 2.2-fold at \(p_0 = 0.05\), 2.5-fold at \(p_0 = 0.25\), and 5.5-fold at \(p_0 = 0.50\). In this benchmark, the LDVB approximation is useful as a rapid first-pass screen, while static MCMC provides a more expensive posterior-simulation comparison when interval accuracy or posterior tail behavior is central.
