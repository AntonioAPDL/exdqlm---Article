...
R> df.scan.print = transform(df.scan, CRPS = round(CRPS, 2), KL = round(KL, 3))
R> print(df.scan.print, row.names = FALSE)
\end{CodeInput}
\begin{CodeOutput}
  X1   X2  CRPS    KL
 0.9 0.85  6.57 0.107
 0.9 0.90  8.21 0.146
 0.9 0.95 10.85 0.173
 0.9 1.00 14.73 0.247
\end{CodeOutput}
\begin{CodeInput}
...
R> axis(side = 1, at = seq(2020, 2023, by = 1))
R> grid(col = "grey90")
